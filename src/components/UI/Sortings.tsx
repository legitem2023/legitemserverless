...
const Sortings = () => {
  ...
  if (Category_loading) return null;
  if (Product_loading) return null;
  if (Brand_loading) return null;
  ...
  return (
    <div className="Search_container_grid">
      <div className="flex-1 flex flex-wrap relative p-2 m-2">
        <Select
          Selected={selectedCategory}
          InitialText="Select Category"
          Name="Category"
          Data={CollapsibleCategory()}
          function_event={(e: any) => dispatch(setCategories(e.target.value))}
        />
      </div>
      <div className="flex-1 flex flex-wrap relative p-2 m-2">
        <Select
          ...
          Name="ProductType"
          Data={CollapsibleProductType()}
          function_event={(e: any) => dispatch(setTypes(e.target.value))}
        />
      </div>
      <div className="flex-1 flex flex-wrap relative p-2 m-2">
        <Select
          Selected={selectedBrand}
          InitialText="Select Brand"
          Name="Brandname"
          Data={CollapsibleBrandName()}
          function_event={(e: any) => dispatch(setBrands(e.target.value))}
        />
      </div>
      <div className="flex-1 flex flex-wrap relative p-2 m-2">
        <Select
          Selected={selectedDepartment}
          InitialText="Select Department"
          Name="Department"
          Data={CollapsibleDepartment()}
          function_event={(e: any) => dispatch(setDepartments(e.target.value))}
        />
      </div>
      <div className="flex-1 flex flex-wrap relative p-2 m-2">
        <Select
          ...
          Name="Status"
          Data={CollapsibleStatus()}
          function_event={(e: any) => dispatch(setStatus(e.target.value))}
        />
      </div>
    </div>
  );
