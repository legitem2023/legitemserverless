...
const handleDetail = (item:any) => {
  ...
  return (
    ...
    <div style={{width:useSlide?"0px":"100%"}} className="left-[0px] right-[0px] mx-auto box-border flex flex-col bg-[#f1f1f1] transition ease-in-out duration-300 top-[10px] fixed overflow-hidden">
      <Detailed/>
