...
const AddItem = () => {
    ...
    const ProductTypeOptions = selectedOptionCategory === ''
        ...
        : ProductType.filter((item: any) => item.category === selectedOptionCategory).map((item: any) => ({
            value: item.type,
            label: item.type,
        }));
    ...
    return (
        <div className='left-0 top-0 w-[100vw] h-[100vh] bg-lime-950 fixed flex items-center justify-center'>
            <div className='w-[50vw] p-4 flex flex-col items-center justify-center bg-[#f1f1f1]'>
                <Titlebar title="Add Item" Icons='mdi:cart' />
                <input
                    type='text'
