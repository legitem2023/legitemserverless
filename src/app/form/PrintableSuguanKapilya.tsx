...
interface Schedule {
  ...
  day: string;
  time: string;
  service?: 'PNK' | 'worship' | 'Distrito' | 'Kapilya';
}
...
interface PrintableSuguanKapilyaProps {
  forms: GroupedSchedule[][];
  filipinoDays: Record<string, string>;
}

export function PrintableSuguanKapilya({ forms, filipinoDays }: PrintableSuguanKapilyaProps) {
  return (
        ...
        >
          ...
          <div className="print-header">
            ...
            <div className="title-container">
              ...
              <p className="title-service">SUGUAN SA PAGBABANTAY SA KAPILYA</p>
            </div>
